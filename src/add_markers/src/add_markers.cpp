...
int main( int argc, char** argv )
{
  ...
  while (ros::ok())
  {
    ...
    ROS_INFO_STREAM("Elapsed " << std::to_string(elapsed_sec));
    ROS_INFO_STREAM("start_time_sec " << std::to_string(start_time_sec));
    ROS_INFO_STREAM("time_sec " << std::to_string(time));
    ...
    // else if (5.0 < elapsed && elapsed <= 10.0) 
    // {
